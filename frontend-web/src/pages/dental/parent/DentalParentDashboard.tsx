...
import { Person, School, EventNote, LocalHospital } from '@mui/icons-material';
...
const percentageHistory = [
  { year: '1st Year BDS', percentage: 75, rank: 8 },
  { year: '2nd Year BDS', percentage: 76.5, rank: 7 },
  { year: '3rd Year BDS (Current)', percentage: 78.5, rank: 5 },
];

const attendanceDetails = [
  { type: 'Theory Sessions', attended: 88, total: 95, percentage: 92.6 },
  { type: 'Clinical Sessions', attended: 85, total: 90, percentage: 94.4 },
  { type: 'Practical Sessions', attended: 78, total: 85, percentage: 91.8 },
];

const recentExams = [
  { exam: 'BDS 3rd Year - Internal Assessment', subject: 'Conservative Dentistry', marks: 42, maxMarks: 50, percentage: 84, grade: 'Distinction' },
  { exam: 'BDS 3rd Year - Clinical Evaluation', subject: 'Oral Surgery', marks: 72, maxMarks: 100, percentage: 72, grade: 'First Class' },
  { exam: 'BDS 3rd Year - Practical Exam', subject: 'Prosthodontics', marks: 38, maxMarks: 50, percentage: 76, grade: 'Distinction' },
];

const upcomingAssessments = [
  { date: '2024-12-20', exam: 'BDS 3rd Year Finals', subject: 'Conservative Dentistry', type: 'Theory + Clinical' },
  { date: '2024-12-22', exam: 'Clinical Assessment', subject: 'Oral Surgery', type: 'Clinical' },
  { date: '2024-12-25', exam: 'Practical Exam', subject: 'Prosthodontics', type: 'Practical' },
];
...
export default function DentalParentDashboard() {
    ...
    <Box>
      <Paper sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #00796B 0%, #004D40 100%)' }}>
        ...
        <Typography variant="body1" sx={{ color: 'rgba(255,255,255,0.9)' }}>
          Academic progress & clinical procedure tracking
        </Typography>
      </Paper>

      <Paper sx={{ p: 3, mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
          <Person sx={{ mr: 2, color: '#00796B' }} />
      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
              <EventNote sx={{ mr: 2, color: '#00796B' }} />
              <Typography variant="h6" sx={{ fontWeight: 600 }}>
                Attendance Overview
              </Typography>
            </Box>
                    ...
                    <TableRow key={index} hover>
                      ...
                      <TableCell>
                        <Chip
                          ...
                          size="small"
                          color={assessment.type.includes('Clinical') ? 'success' : 'primary'}
                        />
                      </TableCell>
                    </TableRow>
                  ))}
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, mb: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <LocalHospital sx={{ mr: 2, color: '#00796B' }} />
              <Typography variant="h6" sx={{ fontWeight: 600 }}>
                Clinical Procedures
              </Typography>
            </Box>
            ...
            <Box sx={{ mb: 2 }}>
              <Typography variant="body2" color="text.secondary">
                Completed: {clinicalProcedures.completed}/{clinicalProcedures.total}
              </Typography>
              <LinearProgress
                variant="determinate"
                value={clinicalProcedures.completionRate}
                sx={{ mt: 1, height: 10, borderRadius: 1 }}
                color="success"
              />
              <Typography variant="h6" sx={{ mt: 1, fontWeight: 700, color: '#00796B' }}>
                {clinicalProcedures.completionRate}%
              </Typography>
            </Box>
          </Paper>

          <Card sx={{ bgcolor: feeStatus.status === 'Paid' ? '#E8F5E9' : '#FFEBEE' }}>
            <CardContent>
              <Typography variant="h6" gutterBottom sx={{ fontWeight: 600 }}>
                Fee Status
              </Typography>
              ...
              <Chip
                ...
                size="small"
                color={feeStatus.status === 'Paid' ? 'success' : 'error'}
                sx={{ mt: 2 }}
              />
            </CardContent>
          </Card>
