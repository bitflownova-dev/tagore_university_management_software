...
export default function ArtsScienceFacultyManagement() {
    ...
    <Box>
      <Paper sx={{ p: 3, mb: 3, background: 'linear-gradient(135deg, #5E35B1 0%, #311B92 100%)' }}>
        <Typography variant="h4" gutterBottom sx={{ fontWeight: 600, color: 'white' }}>
          Arts & Science Faculty Management
        </Typography>
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
          • Faculty-Student Ratio: 1:20 (Current: 1:{(3340 / 136).toFixed(1)}) ✓
        </Typography>
        <Typography variant="body2" color="text.secondary">
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <TextField
                  fullWidth
                  label="Qualification"
                  placeholder="e.g., Ph.D. English Literature"
                  required
                />
              </Grid>
